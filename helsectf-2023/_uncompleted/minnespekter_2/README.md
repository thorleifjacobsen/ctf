...
Her leverer du det vanskeligste flagget fra minnespekter oppgaven.
...
Connecting to the host using python shows that it is a basic memory read prorgam. The area we can read whcih is not protected is from 00000200 - 0001ffff. 
